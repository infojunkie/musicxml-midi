...
@test "musicxml-mma produces a valid file for take-five with swing groove" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/take-five.musicxml)
...
@test "musicxml-mma produces a valid file for take-five with unknown groove" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/take-five-unknown.musicxml)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
  run echo ${mma}
...
@test "musicxml-mma produces a valid file for salma-ya-salama" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/salma-ya-salama.musicxml)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
  run echo ${mma}
...
@test "musicxml-mma produces a valid file for salma-ya-salama with overridden groove" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/salma-ya-salama.musicxml globalGroove=Maqsum)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
  run echo ${mma}
...
@test "musicxml-mma produces a correct sequence for repeats" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/repeats.musicxml)
  run echo ${mma}
...
@test "musicxml-mma produces a valid file for chords" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/chords.musicxml)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
}

@test "musicxml-mma produces a valid and correct file for ties" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/ties.musicxml)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
  run echo ${mma}
...
@test "musicxml-mma produces a valid file for aquele-um" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/aquele-um.musicxml)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
}

@test "musicxml-mma produces a valid file for batwanness-beek" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/batwanness-beek.musicxml)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
}

@test "musicxml-mma produces a valid file for asa-branca" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/asa-branca.musicxml)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
  run echo ${mma}
  assert_output --partial 'BeatAdjust -1'
}

@test "musicxml-mma produces a valid file for that-s-what-friends-are-for" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/that-s-what-friends-are-for.musicxml)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
}

@test "musicxml-mma produces a valid file for capim" {
  mma=$(xslt3 -xsl:src/xsl/musicxml-mma.xsl -s:test/data/capim.musicxml)
  echo "${mma}" | ${MMA_HOME:-./mma}/mma.py -II -n -
}
