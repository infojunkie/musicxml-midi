...
@test "unroll produces an idempotent file for repeats" {
  unroll1=$(mktemp -u)
  xslt3 -xsl:src/xsl/unroll.xsl -s:test/data/repeats.musicxml -o:"$unroll1"
  unroll2=$(mktemp -u)
  xslt3 -xsl:src/xsl/unroll.xsl -s:"$unroll1" -o:"$unroll2"
